...
* [ ] Installation documentation is included
  * this might need to mention a required permission: dcb.all (like oai-pmh.all for edge-oai-pmh)
  * more information is provided at edge-common
  * -_note: read more at https://github.com/folio-org/mod-search/blob/master/README.md_
* [x] Personal data form is completed, accurate, and provided as `PERSONAL_DATA_DISCLOSURE.md` file
  * what about user names in Metadata ? Do those not need to be mentioned ? https://github.com/folio-org/edge-dcb/blob/master/src/main/resources/swagger.api/schemas/common.yaml
...
* [ ] All API endpoints protected with appropriate permissions as per the following guidelines and recommendations, e.g. avoid using `*.all` permissions, all necessary module permissions are assigned, etc.
  * so, better use no permission than an .all permission ? (is this applicable for edge modules ?)
