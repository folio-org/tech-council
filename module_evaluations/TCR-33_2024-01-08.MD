...
* [x] Installation documentation is included
  * -_note: read more at https://github.com/folio-org/mod-batch-print/blob/master/README.md_
* [x] Personal data form is completed, accurate, and provided as [PERSONAL_DATA_DISCLOSURE.md](https://github.com/folio-org/mod-batch-print/blob/master/PERSONAL_DATA_DISCLOSURE.md) file
...
* [x] Module is written in a language and framework from the [officially approved technologies](https://wiki.folio.org/display/TC/Officially+Supported+Technologies) page
  * _Module is written in Java 17_
  * _Module is using org.folio.vertx-lib 3.1.2 as base for vert.x_
...
* [x] Module's repository includes a compliant Module Descriptor
  * -_note: read more at [ModuleDescriptor-template.json](https://github.com/folio-org/mod-batch-print/blob/master/descriptors/ModuleDescriptor-template.json)_
...
* [x] All API endpoints are documented in RAML or [OpenAPI](https://github.com/folio-org/mod-batch-print/blob/master/src/main/resources/openapi/batchPrint.yaml)
