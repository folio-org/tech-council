...
* [ ] The module doesn't access data in DB schemas other than its own and public
  - Because the views used by this application are normal (and not material) some of the data accessed by this application should be considered to be outside its own schema
