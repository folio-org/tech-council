...
* [x] Module build MUST produce a valid module descriptor
  * module descriptor is there. I found pubsub in pom.xml , so does it use Kafka ? If so, KAFKA_HOST, KAFKA_PORT should be in "env" part of the launch descriptor.
  * otherwise, module descriptor with launch descriptor looks complete and accurate.
  * There is also  src/main/resources/application.yml . But what is it ? An application descriptor ?
* [ ] Module descriptor MUST include interface requirements for all consumed APIs
  * presumably O.K. (is this the "requires" section ? 
* [x] Third party dependencies use an Apache 2.0 compatible license
* [x] Installation documentation is included
  * -_note: read more at https://github.com/folio-org/mod-search/blob/master/README.md_
* [x] Personal data form is completed, accurate, and provided as `PERSONAL_DATA_DISCLOSURE.md` file
* [x] Sensitive and environment-specific information is not checked into git repository
  * Couldn't find any in src/main/resources, other config files or elsewhere in the repo.
...
* [ ] Module gracefully handles the absence of third party systems or related configuration
  * probably. Are there any third party systems involved ?
...
* [ ] All API endpoints are documented in RAML or OpenAPI
  * IK
    * documentation in https://dev.folio.org/reference/api/ (view-1, view-2 not there; only view-4 is there), uses yaml file instead or raml: possibly O.K.; some modules do that.
      * => documentation is good. With item examples and thorough field descriptions (json format) of items. [x]
    * some documentation missing ? Possible responses of GET  /circulation-item  in src/main/resources/swagger.api/circulation-item.yaml : 200, ..., ?
...
* [ ] If provided, integration (API) tests must be written in an [officially approved technology](https://wiki.folio.org/display/TC/Officially+Supported+Technologies)
  ...
  * integration tests are in src/test/java, should be under https://github.com/folio-org/folio-integration-tests ?
* [ ] Data is segregated by tenant at the storage layer
  * IK: where exactly can I see that ?
...
* [ ] Standard GET `/admin/health` endpoint returning a 200 response
  ...
  * IK: fulfilled because pom.xml includes artfactId spring-boot-starter-actuator ?
