...
* [ ] Module descriptor MUST include interface requirements for all consumed APIs
  * are all permissions included ? What about item-storage, holdings-storage, service-point permissions in the modulePermissions sections of the module descriptor ?
* [ ] Third party dependencies use an Apache 2.0 compatible license
  * IK: not fulfilled for testcontainers.org: MIT License. Dito for wiremock.org.
* [x] Installation documentation is included
  * -_note: read more at https://github.com/folio-org/mod-search/blob/master/README.md_
* [ ] Personal data form is completed, accurate, and provided as `PERSONAL_DATA_DISCLOSURE.md` file
  * includes username in resources/mappings/users.json ?
...
* [ ] Module includes executable implementations of all endpoints in the provides section of the Module Descriptor
  *  createCirculationRequest, getTransactionStatus und updateTransactionStatus have been implemented in src/main/java/org/folio/dcb/controller/TransactionApiController.java . They corresponds to the POST, GET and PUT methods in the provides section. O.K.
  * POST /_/tenant and GET,DELETE /_/tenant/{id} is in the provides section, but is not an endpoint of the module (?)
* [x] Environment vars are documented in the ModuleDescriptor
  * -_note: read more at [https://wiki.folio.org/pages/viewpage.action?pageId=65110683](https://wiki.folio.org/pages/viewpage.action?pageId=65110683)
* [ ] If a module provides interfaces intended to be consumed by other FOLIO Modules, they must be defined in the Module Descriptor "provides" section
  * see above. O.K. for POST /transactions/{dbTransactionId} and GET,PUT /transactions/{dbTransactionId}/status
...
* [x] If provided, integration (API) tests must be written in an [officially approved technology](https://wiki.folio.org/display/TC/Officially+Supported+Technologies)
  ...
  * IK: Tests are in https://github.com/folio-org/folio-integration-tests
...
* [x] Standard GET `/admin/health` endpoint returning a 200 response
  ...
  * IK: pom.xml includes artifactId spring-boot-starter-actuator
