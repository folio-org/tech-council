...
* [ ] Module only uses infrastructure / platform technologies on the [officially approved technologies](https://wiki.folio.org/display/TC/Officially+Supported+Technologies) list.
  * _e.g. PostgreSQL, ElasticSearch, etc._
  // IK: The folio-spring-base.version 7.2.2 is maybe a little outdated ? (we support folio-spring-base 7.4 for Quesnelia)
  // some includes in the pom which I don't know (and not documented on the OST-page): mapstruct.version 1.5.3.Final, wiremock.version 2.27.2
